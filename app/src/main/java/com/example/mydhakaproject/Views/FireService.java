...
public class FireService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.fire_service_progress_bar);

        recyclerView = findViewById(R.id.FireServiceRecyclerView);

        searchView = findViewById(R.id.fire_service_search_view);

        recycler_title = findViewById(R.id.fire_service_recycler_title);
    ...
    public void getData() {
        ...
        String url = "https://mydhaka.000webhostapp.com/My%20Dhaka/fire_service.json";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                recycler_title.setText("Fire Service:");


                try {
                    JSONArray jsonArray = response.getJSONArray("Fire_Service");
                ...
                fireServiceAdapter = new FireServiceAdapter(getApplicationContext(),FireService.this, list);
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    if (list.get(i).getName().toLowerCase().contains(newText.toLowerCase()) || list.get(i).getAddress().toLowerCase().contains(newText.toLowerCase())) {
                        ...
                        fireServiceAdapter.filteredList(searchList);
                    }
                }
    ...
    public void ImageSlider() {
        ...
        ImageSlider imageSlider = findViewById(R.id.fire_service_image_slider);
