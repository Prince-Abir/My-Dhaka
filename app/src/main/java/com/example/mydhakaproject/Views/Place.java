...
public class Place extends AppCompatActivity {
    ...
    public void ImageSlider() {
        ...
        ItemList.add(new SlideModel(R.drawable.placeone, ScaleTypes.FIT));
        ItemList.add(new SlideModel(R.drawable.placetwo, ScaleTypes.FIT));
        ItemList.add(new SlideModel(R.drawable.placethree, ScaleTypes.FIT));
        ItemList.add(new SlideModel(R.drawable.placefour, ScaleTypes.FIT));
        ItemList.add(new SlideModel(R.drawable.placefive, ScaleTypes.FIT));
        ItemList.add(new SlideModel(R.drawable.placesix, ScaleTypes.FIT));
        ItemList.add(new SlideModel(R.drawable.placeseven, ScaleTypes.FIT));
